...
who = [
  "<br>",'Aspiring Security Professional with 3+ years as a client systems technician in the Air Force,\
  seeking to leverage my experience in troubleshooting and problem-solving to help your company stay secure and \
  compliant. I am a passionate teammate and a quick learner, with a strong curiosity for how systems work and a \
  love for using creativity and automation to solve problems. I am eager to use my passion for IT and \
  security concepts to develop and implement effective security solutions that meet your organization\'s\
  unique needs.',"<br>"
];
